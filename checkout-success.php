...
<body class="bg-body-tertiary">
  ...
  <br><br><br>
        ...
        <center><img src="img/Thankyou.png" width="600" height="320"><center>
<br>
        <center><div class="card w-50">
          <div class="card-body">
            <h5 class="card-title">RACHASAWEI</h5>
            <p class="card-text">On its way to delivery, Please wait a moment.</p>
            <p class="card-text">Enjoy eating every day.</p>
            <a href="http://localhost/shoppingcart/product-list.php" class="btn btn-primary">THANK YOU</a>
        </div>
        </div><center>
        <br><br><br>
</body>
