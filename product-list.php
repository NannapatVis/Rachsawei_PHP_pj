...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
        ...
        <div class="row d-flex justify-content-center">
            <?php if($rows > 0): ?>
                ...
                <div class="col-4 mb-4">
                    <div class="card" while="300" height="300;">  
                        ...
                        <?php endif; ?>
                        <div class="card-body">
                            <center><h5 class="card-title"><?php echo $product['product_name']; ?></h5>
                            <p class="card-text text-success fw-bold mb-0"><?php echo number_format($product['price'], 2); ?> Baht</p></center>
                            <BR>
                            
                            <div class="d-grid gap-1 d-md-flex justify-content-md-end">
                            <a href="<?php echo $base_url; ?>\menu.php?id=<?php echo $product['id']; ?>" class="btn btn-primary w-100 "><i class=""></i><center>View</center></a><br><br>  
    ...
    <li class="nav-item">
          <a class="nav-link" href="http:\\localhost\shoppingcart\register\admin_login.php" class="nav-link"><center><p class="text-secondary
"><font size ="4.5">ADMIN</font></p></center></a>
        </li>
      </footer>
